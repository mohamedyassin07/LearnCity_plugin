...
$group_obj = groups_get_group (get_post_meta($post_id , 'bp_group' , true ));
...
<style>
.course__sidebar_buddypree_toggle{
    position: absolute;
    right: 30px;
    top:100px ;
    font-size: 22px;
    ...
    line-height: 50px;
    border-radius: 50%;
    border: 2px solid #17d292;
    background-color: #17d292;
    text-align: center;
    cursor: pointer;
    
}
.course__sidebar_buddypree_toggle a ,  .course__sidebar_buddypree_toggle a:hover{
    color: #fff;
    cursor: pointer;
}
</style>
            <div class="course__sidebar_buddypree_toggle">
                    <a href="<?= $group_link; ?>">
